...
export class MinhasEstatisticasComponent implements OnInit {
   ...
   */
  constructor(private title: Title, private avaliacaoService: AvaliacaoService, private usuarioService: UsuarioService) {
  }
  ...
  public listEstatisticasByDates(dataInicio, dataFim) {
    ...
    this.avaliacaoService
      .listAvaliacoesByAtendenteKey(this.usuarioLogado.key)
      .subscribe(avaliacao => {
