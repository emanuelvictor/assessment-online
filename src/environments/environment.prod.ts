export const environment = {
  ...
  // },
  //
  // handlerUserUrl : 'https://us-central1-assessment-online.cloudfunctions.net/handlerUser',
  ...
  handlerUserUrl : 'https://us-central1-d-assessment-online.cloudfunctions.net/handlerUser'
};
