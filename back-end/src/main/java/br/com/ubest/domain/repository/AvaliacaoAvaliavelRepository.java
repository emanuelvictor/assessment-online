...
public interface AvaliacaoAvaliavelRepository extends JpaRepository<AvaliacaoAvaliavel, Long> {
     ...
     * @return List<AvaliacaoAvaliavel>
     */
    @Query("FROM AvaliacaoAvaliavel avaliacaoAvaliavel WHERE avaliacaoAvaliavel.avaliavel.unidadeTipoAvaliacaoLicenca.unidadeTipoAvaliacao.unidade.id = :unidadeId")
     ...
     * @return List<AvaliacaoAvaliavel>
     */
    List<AvaliacaoAvaliavel> findAllByAvaliacaoId(@Param("avaliacaoId") final long avaliacaoId);
}
