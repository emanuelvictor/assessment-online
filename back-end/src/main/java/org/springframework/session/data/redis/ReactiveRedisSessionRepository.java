...
public class ReactiveRedisSessionRepository
    ...
    public Mono<RedisSession> findById(String id) {
        ...
        // FIXME
        // Buf of default behavior of the spring framework
        // When token is empty or null, this method must return void (or empty - Mono.empty())
        // This permit the migration of sessions between distinct technologies
