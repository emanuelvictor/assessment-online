...
(function ($) {
  ...
  window.methods = {
    ...
    $.fn.galleryExpand = function(methodOrOptions) {
      if ( window.methods[methodOrOptions] ) {
        console.log(arguments);
        return window.methods[ methodOrOptions ].apply( this, Array.prototype.slice.call( arguments, 1 ));
      } else if ( typeof methodOrOptions === 'object' || ! methodOrOptions ) {
        // Default to "init"
        console.log(arguments);
        return window.methods.init.apply( this, arguments );
      } else {
