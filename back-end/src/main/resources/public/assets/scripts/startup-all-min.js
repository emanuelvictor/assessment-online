  ...
  _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (t, e, i) {
    ...
    r.version = "1.15.1",
      ...
      h.render = function (t, e, i) {
        ...
        var n, r, a, l, h, c, f, p, d = this._dirty ? this.totalDuration() : this._totalDuration, m = this._time,
          _ = this._totalTime, g = this._cycle, v = this._duration, y = this._rawPrevTime;
    ...
    _gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (t, e, i) {
      ...
      return n.version = "1.15.1",
        ...
        _.render = function (t, e, i) {
          ...
          var n, s, o, a, l, f = this._dirty ? this.totalDuration() : this._totalDuration, p = this._time,
            d = this._startTime, m = this._timeScale, _ = this._paused;
    ...
    _gsScope._gsDefine("TimelineMax", ["TimelineLite", "TweenLite", "easing.Ease"], function (t, e, i) {
      ...
      return u.constructor = n,
        ...
        u.render = function (t, e, i) {
          this._gc && this._enabled(!0, !1);
          var n, o, h, u, c, f, p = this._dirty ? this.totalDuration() : this._totalDuration, d = this._duration,
            m = this._time, _ = this._totalTime, g = this._startTime, v = this._timeScale, y = this._rawPrevTime,
    ...
    function () {
      var t = 180 / Math.PI
        ...
        , m = _gsScope._gsDefine.plugin({
          ...
          set: function (e) {
            var i, n, r, s, o, a, l, h, u, c, f = this._segCount, p = this._func, d = this._target,
    ...
    _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function (t, e) {
      ...
      var u, c, f, p, d, m, _ = /(?:\d|\-\d|\.\d|\-\.\d)+/g, g = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g,
        v = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, y = /(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g,
        T = /(?:\d|\-|\+|=|#|\.)*/g, w = /opacity *= *([^)]*)/i, x = /opacity:([^;]*)/i, b = /alpha\(opacity *=.+?\)/i,
        P = /^(rgb|hsl)/, S = /([A-Z])/g, C = /-([a-z])/gi, O = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi,
        E = function (t, e) {
          return e.toUpperCase()
        }, R = /(?:Left|Right|Width)/i, k = /(M11|M12|M21|M22)=[\d\-\.e]+/gi,
        z = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, A = /,(?=[^\)]*(?:\(|$))/gi, M = Math.PI / 180,
        L = 180 / Math.PI, I = {}, D = document, F = function (t) {
      ...
      var ct = function (t, e, i, n) {
        if (null == t)
          return function (t) {
            ...
            ;
        var r, s = e ? (t.match(ut) || [""])[0] : "", o = t.split(s).join("").match(v) || [],
          a = t.substr(0, t.indexOf(o[0])), l = ")" === t.charAt(t.length - 1) ? ")" : "",
          h = -1 !== t.indexOf(" ") ? " " : ",", u = o.length, c = u > 0 ? o[0].replace(_, "") : "";
        ...
        var c, f, p, d, m, v, y, T, w, x, b, S, C = i.split(", ").join(",").split(" "),
          O = n.split(", ").join(",").split(" "), E = C.length, R = u !== !1;
      ...
      var Tt,
        ...
        xt = V("transform"), bt = H + "transform", Pt = V("transformOrigin"), St = null !== V("perspective"),
        ...
        , Ot = window.SVGElement, Et = function (t, e, i) {
          ...
          var s, a, l, h, u, c, f, p, d, m, _ = i ? t._gsTransform || new Ct : new Ct, g = 0 > _.scaleX, v = 2e-5,
            y = 1e5, T = St ? parseFloat(G(t, Pt, e, !1, "0 0 0").split(" ")[2]) || _.zOrigin || 0 : 0,
          ...
          if (xt ? a = G(t, bt, e, !0) : t.currentStyle && (a = t.currentStyle.filter.match(k),
            ...
            if (16 === l.length) {
              var x, b, P, S, C, O = l[0], E = l[1], R = l[2], z = l[3], A = l[4], M = l[5], I = l[6], D = l[7], F = l[8],
                N = l[9], j = l[10], W = l[12], B = l[13], X = l[14], Y = l[11], q = Math.atan2(I, j);
        ...
        , Mt = function (t) {
          var e, i, n = this.data, r = -n.rotation * M, s = r + n.skewX * M, o = 1e5,
            a = (0 | Math.cos(r) * n.scaleX * o) / o, l = (0 | Math.sin(r) * n.scaleX * o) / o,
            h = (0 | Math.sin(s) * -n.scaleY * o) / o, u = (0 | Math.cos(s) * n.scaleY * o) / o, c = this.t.style,
          ...
          if (f) {
            i = l,
              ...
              e = f.filter,
              c.filter = "";
            var p, d, _ = this.t.offsetWidth, g = this.t.offsetHeight, v = "absolute" !== f.position,
              y = "progid:DXImageTransform.Microsoft.Matrix(M11=" + a + ", M12=" + l + ", M21=" + h + ", M22=" + u,
              x = n.x + _ * n.xPercent / 100, b = n.y + g * n.yPercent / 100;
          ...
          var e, i, n, r, s, o, a, l, h, u, c, f, d, m, _, g, v, y, T, w, x, b = this.data, P = this.t.style,
            S = b.rotation * M, C = b.scaleX, O = b.scaleY, E = b.scaleZ, R = b.x, k = b.y, z = b.z, A = b.perspective;
      ...
      h = Ct.prototype,
        ...
        vt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
          parser: function (t, e, i, n, s, a, l) {
            ...
            var h, u, c, f, p, d, m, _ = n._transform = At(t, r, !0, l.parseTransform), g = t.style, v = 1e-6,
              y = wt.length, T = l, w = {};
        ...
        vt("borderRadius", {
          ...
          parser: function (t, e, i, s, o) {
            e = this.format(e);
            var a, l, h, u, c, f, p, d, m, _, g, v, y, T, w, x,
        ...
        vt("backgroundPosition", {
          ...
          parser: function (t, e, i, n, s, o) {
            var a, l, h, u, c, f, p = "background-position", d = r || Q(t, null),
...
_gsScope._gsDefine && _gsScope._gsQueue.pop()(),
  ...
  !function (t, e) {
    ...
    t.Controller = function (n) {
      var s, o, a = "ScrollMagic.Controller", l = "FORWARD", h = "REVERSE", u = "PAUSED", c = i.defaults, f = this,
        p = r.extend({}, c, n), d = [], m = !1, _ = 0, g = u, v = !0, y = 0, T = !0, w = function () {
          for (var t in p)
    ...
    t.Controller.addOption = function (t, e) {
      ...
      ,
      t.Scene = function (i) {
        var s, o, a = "BEFORE", l = "DURING", h = "AFTER", u = n.defaults, c = this, f = r.extend({}, u, i), p = a,
          d = 0, m = {
            start: 0,
            end: 0
          }, _ = 0, g = !0, v = function () {
