        ...
        return n.htmlInit = function(i, r) {
            e(function() {
                for (var e = n.toDashed(r), o = document.querySelectorAll(".js-" + e), a = "data-" + e + "-options", l = 0, h = o.length; h > l; l++) {
                    var u, c = o[l], f = c.getAttribute(a);
                    try {
                        u = f && JSON.parse(f)
                    } catch (p) {
    ...
    _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
        ...
        r.version = "1.15.1",
            ...
            h.render = function(t, e, i) {
                ...
                var n, r, a, l, h, c, f, p, d = this._dirty ? this.totalDuration() : this._totalDuration, m = this._time, _ = this._totalTime, g = this._cycle, v = this._duration, y = this._rawPrevTime;
        ...
        r.killAll = function(t, i, n, r) {
            null == i && (i = !0),
            null == n && (n = !0);
            var s, o, a, l = f(0 != r), h = l.length, u = i && n && r;
            for (a = 0; h > a; a++)
                o = l[a],
        ...
        var p = function(t, i, n, r) {
            i = i !== !1,
                n = n !== !1,
                r = r !== !1;
            for (var s, o, a = f(r), l = i && n && r, h = a.length; --h > -1; )
                o = a[h],
        ...
        _gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
            ...
            return n.version = "1.15.1",
                ...
                _.render = function(t, e, i) {
                    ...
                    var n, s, o, a, l, f = this._dirty ? this.totalDuration() : this._totalDuration, p = this._time, d = this._startTime, m = this._timeScale, _ = this._paused;
                    if (t >= f ? (this._totalTime = this._time = f,
                        ...
                        this._rawPrevTime > r && (a = "onReverseComplete"))),
                            ...
                            t = f + 1e-4) : 1e-7 > t ? (this._totalTime = this._time = 0,
                        ...
                        a && (this._gc || (d === this._startTime || m !== this._timeScale) && (0 === this._time || f >= this.totalDuration()) && (s && (h.length && u(),
        ...
        _gsScope._gsDefine("TimelineMax", ["TimelineLite", "TweenLite", "easing.Ease"], function(t, e, i) {
            ...
            return u.constructor = n,
                ...
                u.render = function(t, e, i) {
                    this._gc && this._enabled(!0, !1);
                    var n, o, h, u, c, f, p = this._dirty ? this.totalDuration() : this._totalDuration, d = this._duration, m = this._time, _ = this._totalTime, g = this._startTime, v = this._timeScale, y = this._rawPrevTime, T = this._paused, w = this._cycle;
                    ...
                    u && (this._locked || this._gc || (g === this._startTime || v !== this._timeScale) && (0 === this._time || p >= this.totalDuration()) && (o && (a.length && l(),
                    this._timeline.autoRemoveChildren && this._enabled(!1, !1),
                        this._active = !1),
        ...
        function() {
            var t = 180 / Math.PI
                ...
                var h, u, c, f, p, d, m, _, g, v, y, T, w, x = t.length - 1, b = 0, P = t[0].a;
                for (h = 0; x > h; h++)
                    p = t[b],
                        u = p.a,
                        c = p.d,
                ...
                var p, d, m, _, g, v, y, T, w = {}, x = [], b = f || t[0];
                ...
                , f = function(t, e, i) {
                e = e || "soft";
                var n, r, s, a, l, h, u, c, f, p, d, m = {}, _ = "cubic" === e ? 3 : 2, g = "soft" === e, v = [];
                if (g && i && (t = [i].concat(t)),
                    null == t || _ + 1 > t.length)
                ...
                for (h = v.length; --h > -1; ) {
                    for (f = v[h],
                             ...
                             c = t.length,
                             u = 0; c > u; u++)
                        n = null == i ? t[u][f] : "string" == typeof (d = t[u][f]) && "=" === d.charAt(1) ? i[f] + Number(d.charAt(0) + d.substr(2)) : Number(d),
                    ...
                    for (c = p - _ + 1,
                        ...
                        n = l[u],
                            ...
                            s = l[u + 2],
                            a = 2 === _ ? 0 : l[u + 3],
                            l[p++] = d = 3 === _ ? new o(n,r,s,a) : new o(n,(2 * r + n) / 3,(2 * r + s) / 3,s);
                    l.length = p
                }
                return m
            }
                ...
                , d = function(t, e) {
                e = e >> 0 || 6;
                var i, n, r, s, o = [], a = [], l = 0, h = 0, u = e - 1, c = [], f = [];
                for (i in t)
                    p(t[i], o, e);
                for (r = o.length,
                         n = 0; r > n; n++)
                ...
                init: function(t, e, i) {
                    ...
                    var n, r, s, o, a, l = e.values || [], h = {}, u = l[0], p = e.autoRotate || i.vars.orientToBezier;
                    ...
                    for (s = this._props.length; --s > -1; )
                        ...
                        a || h[n] !== l[0][n] && (a = h);
                    if (this._beziers = "cubic" !== e.type && "quadratic" !== e.type && "soft" !== e.type ? c(l, isNaN(e.curviness) ? 1 : e.curviness, !1, "thruBasic" === e.type, e.correlate, a) : f(l, e.type, h),
                ...
                set: function(e) {
                    var i, n, r, s, o, a, l, h, u, c, f = this._segCount, p = this._func, d = this._target, m = e !== this._startRatio;
                    if (this._timeRes) {
                        if (u = this._lengths,
                                c = this._curSeg,
                                e *= this._length,
                        ...
                        e._registerComplexSpecialProp("bezier", {
                            parser: function(t, e, s, o, a, l) {
                                e instanceof Array && (e = {
                                    ...
                                    l = new m;
                                var h, u, c, f = e.values, p = f.length - 1, d = [], _ = {};
                                if (0 > p)
                                    return a;
                                for (h = 0; p >= h; h++)
                                    c = i(t, f[h], o, a, l, p !== h),
        ...
        _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
            ...
            var u, c, f, p, d, m, _ = /(?:\d|\-\d|\.\d|\-\.\d)+/g, g = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, v = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, y = /(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g, T = /(?:\d|\-|\+|=|#|\.)*/g, w = /opacity *= *([^)]*)/i, x = /opacity:([^;]*)/i, b = /alpha\(opacity *=.+?\)/i, P = /^(rgb|hsl)/, S = /([A-Z])/g, C = /-([a-z])/gi, O = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, E = function(t, e) {
                ...
                var t = B.indexOf("Android")
                    , e = F("a");
                return f = -1 !== B.indexOf("Safari") && -1 === B.indexOf("Chrome") && (-1 === t || Number(B.substr(t + 8, 1)) > 3),
                ...
                if ("auto" === r || !n)
                    return 0;
                var a, l, h, u = R.test(i), c = t, f = N.style, p = 0 > n;
                if (p && (n = -n),
            ...
            var ct = function(t, e, i, n) {
                ...
                , dt = (W._parseToProxy = function(t, e, i, n, r, s) {
                    var o, a, l, h, u, c = n, f = {}, p = {}, d = i._transform, m = I;
                ...
                i = i || s || "",
                    ...
                    n += "";
                var c, f, p, d, m, v, y, T, w, x, b, S, C = i.split(", ").join(",").split(" "), O = n.split(", ").join(",").split(" "), E = C.length, R = u !== !1;
                for ((-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && (C = C.join(" ").replace(A, ", ").split(" "),
                    ...
                    if (d = C[c],
                        ...
                        for (p = 0,
                            ...
                            b = v[f],
                                x = d.indexOf(b, p),
                                o.appendXtra(d.substr(p, x - p), Number(b), rt(y[f], b), "", R && "px" === d.substr(x + b.length, 2), 0 === f),
                                p = x + b.length;
                        o["xs" + o.l] += d.substr(p)
                    } else
                        o["xs" + o.l] += o.l ? " " + d : d;
            ...
            ;
            var Tt, wt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","), xt = V("transform"), bt = H + "transform", Pt = V("transformOrigin"), St = null !== V("perspective"), Ct = W.Transform = function() {
                ...
                , Ot = window.SVGElement, Et = function(t, e, i) {
                    ...
                    var s, a, l, h, u, c, f, p, d, m, _ = i ? t._gsTransform || new Ct : new Ct, g = 0 > _.scaleX, v = 2e-5, y = 1e5, T = St ? parseFloat(G(t, Pt, e, !1, "0 0 0").split(" ")[2]) || _.zOrigin || 0 : 0, w = parseFloat(o.defaultTransformPerspective) || 0;
                    if (xt ? a = G(t, bt, e, !0) : t.currentStyle && (a = t.currentStyle.filter.match(k),
                        ...
                        if (16 === l.length) {
                            ...
                            Math.abs(m) > 90 && 270 > Math.abs(m) && (g ? (f *= -1,
                                m += 0 >= d ? 180 : -180,
                                d += 0 >= d ? 180 : -180) : (p *= -1,
                                m += 0 >= m ? 180 : -180)),
                                _.scaleX = f,
                ...
                , Mt = function(t) {
                    var e, i, n = this.data, r = -n.rotation * M, s = r + n.skewX * M, o = 1e5, a = (0 | Math.cos(r) * n.scaleX * o) / o, l = (0 | Math.sin(r) * n.scaleX * o) / o, h = (0 | Math.sin(s) * -n.scaleY * o) / o, u = (0 | Math.cos(s) * n.scaleY * o) / o, c = this.t.style, f = this.t.currentStyle;
                    if (f) {
                        i = l,
                            l = -h,
                            h = -i,
                            e = f.filter,
                            c.filter = "";
                        var p, d, _ = this.t.offsetWidth, g = this.t.offsetHeight, v = "absolute" !== f.position, y = "progid:DXImageTransform.Microsoft.Matrix(M11=" + a + ", M12=" + l + ", M21=" + h + ", M22=" + u, x = n.x + _ * n.xPercent / 100, b = n.y + g * n.yPercent / 100;
                        if (null != n.ox && (p = (n.oxp ? .01 * _ * n.ox : n.ox) - _ / 2,
                                d = (n.oyp ? .01 * g * n.oy : n.oy) - g / 2,
                                x += p - (p * a + d * l),
                                b += d - (p * h + d * u)),
                                v ? (p = _ / 2,
                                    d = g / 2,
                                    y += ", Dx=" + (p - (p * a + d * l) + x) + ", Dy=" + (d - (p * h + d * u) + b) + ")") : y += ", sizingMethod='auto expand')",
                    ...
                    var e, i, n, r, s, o, a, l, h, u, c, f, d, m, _, g, v, y, T, w, x, b = this.data, P = this.t.style, S = b.rotation * M, C = b.scaleX, O = b.scaleY, E = b.scaleZ, R = b.x, k = b.y, z = b.z, A = b.perspective;
                    ...
                    m > z && z > -m && (z = 0)),
                        ...
                        b.rotationX || b.rotationY ? (T += w + (m > l && l > -m ? x : l) + w + (m > c && c > -m ? x : c) + w + (m > n && n > -m ? x : n),
                            T += w + (m > o && o > -m ? x : o) + w + (m > h && h > -m ? x : h) + w + (m > f && f > -m ? x : f) + w) : T += ",0,0,0,0,1,0,",
                        T += R + w + k + w + z + w + (A ? 1 + -z / A : 1) + ")",
                        P[xt] = T
                }
                , It = W.set2DTransformRatio = function(t) {
                    var e, i, n, r, s, o, a, l, h, u, c, f = this.data, p = this.t, d = p.style, m = f.x, _ = f.y;
                    return !(f.rotationX || f.rotationY || f.z || f.force3D === !0 || "auto" === f.force3D && 1 !== t && 0 !== t) || f.svg && Tt || !St ? (r = f.scaleX,
                        s = f.scaleY,
                        void (f.rotation || f.skewX || f.svg ? (e = f.rotation * M,
                            i = e - f.skewX * M,
                            n = 1e5,
                            o = Math.cos(e) * r,
                            a = Math.sin(e) * r,
                            l = Math.sin(i) * -s,
                            h = Math.cos(i) * s,
                        f.svg && (m += f.xOrigin - (f.xOrigin * o + f.yOrigin * l),
                            _ += f.yOrigin - (f.xOrigin * a + f.yOrigin * h),
                            c = 1e-6,
                        c > m && m > -c && (m = 0),
                        c > _ && _ > -c && (_ = 0)),
                            u = (0 | o * n) / n + "," + (0 | a * n) / n + "," + (0 | l * n) / n + "," + (0 | h * n) / n + "," + m + "," + _ + ")",
                            f.svg && Tt ? p.setAttribute("transform", "matrix(" + u) : d[xt] = (f.xPercent || f.yPercent ? "translate(" + f.xPercent + "%," + f.yPercent + "%) matrix(" : "matrix(") + u) : d[xt] = (f.xPercent || f.yPercent ? "translate(" + f.xPercent + "%," + f.yPercent + "%) matrix(" : "matrix(") + r + ",0,0," + s + "," + m + "," + _ + ")")) : (this.setRatio = Lt,
                        void Lt.call(this, t))
                }
            ;
            h = Ct.prototype,
                ...
                vt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
                    parser: function(t, e, i, n, s, a, l) {
                        ...
                        var h, u, c, f, p, d, m, _ = n._transform = At(t, r, !0, l.parseTransform), g = t.style, v = 1e-6, y = wt.length, T = l, w = {};
                        ...
                        for (St && null != T.force3D && (_.force3D = T.force3D,
                            ...
                            i = wt[y],
                                f = h[i] - _[i],
                            (f > v || -v > f || null != T[i] || null != I[i]) && (d = !0,
                                s = new dt(_,i,_[i],f,s),
                            i in w && (s.e = w[i]),
                                s.xs0 = 0,
                                s.plugin = a,
                                n._overwriteProps.push(s.n));
                        return f = T.transformOrigin,
                        f && _.svg && (zt(t, nt(f), h),
                        ...
                        (f || St && p && _.zOrigin) && (xt ? (d = !0,
                            ...
                            St ? (c = _.zOrigin,
                                ...
                                s.b = c,
                                s.xs0 = s.e = _.zOrigin) : s.xs0 = s.e = f) : nt(f + "", _)),
                ...
                vt("borderRadius", {
                    ...
                    parser: function(t, e, i, s, o) {
                        e = this.format(e);
                        var a, l, h, u, c, f, p, d, m, _, g, v, y, T, w, x, b = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"], P = t.style;
                        for (m = parseFloat(t.offsetWidth),
                            ...
                            -1 !== c.indexOf(" ") && (u = c.split(" "),
                                ...
                                y ? (d = parseInt(f.charAt(0) + "1", 10),
                                    f = f.substr(2),
                                    d *= parseFloat(f),
                                    g = f.substr((d + "").length - (0 > d ? 1 : 0)) || "") : (d = parseFloat(f),
                                    g = f.substr((d + "").length)),
                            "" === g && (g = n[i] || v),
                            g !== v && (T = $(t, "borderLeft", p, v),
                                w = $(t, "borderTop", p, v),
                                "%" === g ? (c = 100 * (T / m) + "%",
                ...
                vt("backgroundPosition", {
                    ...
                    parser: function(t, e, i, n, s, o) {
                        var a, l, h, u, c, f, p = "background-position", d = r || Q(t, null), _ = this.format((d ? m ? d.getPropertyValue(p + "-x") + " " + d.getPropertyValue(p + "-y") : d.getPropertyValue(p) : t.currentStyle.backgroundPositionX + " " + t.currentStyle.backgroundPositionY) || "0 0"), g = this.format(e);
                        if (-1 !== _.indexOf("%") != (-1 !== g.indexOf("%")) && (f = G(t, "backgroundImage").replace(O, ""),
                            f && "none" !== f)) {
                            for (a = _.split(" "),
                                     l = g.split(" "),
            ...
            vt("className", {
                parser: function(t, e, n, s, o, a, l) {
                    var h, u, c, f, p, d = t.getAttribute("class") || "", m = t.style.cssText;
                    ...
                    if (i) {
                        for (; h; ) {
                            for (g = h._next,
                                     p = m; p && p.pr > h.pr; )
                                p = p._next;
                            (h._prev = p ? p._prev : _) ? h._prev._next = h : m = h,
                                (h._next = p) ? p._prev = h : _ = h,
                                h = g
                        }
                        this._firstPT = m
                    }
                    ...
                    for (o in e)
                        p = e[o],
                            ...
                            a ? i = a.parse(t, p, o, this, i, s, e) : (f = G(t, o, r) + "",
                                _ = "string" == typeof p,
                                "color" === o || "fill" === o || "stroke" === o || -1 !== o.indexOf("Color") || _ && P.test(p) ? (_ || (p = ht(p),
                                    p = (p.length > 3 ? "rgba(" : "rgb(") + p.join(",") + ")"),
                                    i = mt(v, o, f, p, !0, "transparent", i, 0, s)) : !_ || -1 === p.indexOf(" ") && -1 === p.indexOf(",") ? (h = parseFloat(f),
                                    d = h || 0 === h ? f.substr((h + "").length) : "",
                                ("" === f || "auto" === f) && ("width" === o || "height" === o ? (h = it(t, o, r),
                                    ...
                                    g ? (c = parseInt(p.charAt(0) + "1", 10),
                                        p = p.substr(2),
                                        c *= parseFloat(p),
                                        m = p.replace(T, "")) : (c = parseFloat(p),
                                        m = _ ? p.replace(T, "") : ""),
                                "" === m && (m = o in n ? n[o] : d),
                                    p = c || 0 === c ? (g ? c + h : c) + m : e[o],
                                d !== m && "" !== m && (c || 0 === c) && h && (h = $(t, o, h, d),
                                    "%" === m ? (h /= $(t, o, 100, "%") / 100,
                                    e.strictUnits !== !0 && (f = h + "%")) : "em" === m ? h /= $(t, o, 1, "em") : "px" !== m && (c = $(t, o, c, m),
                                        m = "px"),
                                g && (c || 0 === c) && (p = c + h + m)),
                                g && (c += h),
                                    !h && 0 !== h || !c && 0 !== c ? void 0 !== v[o] && (p || "NaN" != p + "" && null != p) ? (i = new dt(v,o,c || h || 0,0,i,-1,o,!1,0,f,p),
                                        i.xs0 = "none" !== p || "display" !== o && -1 === o.indexOf("Style") ? p : f) : q("invalid " + o + " tween value: " + e[o]) : (i = new dt(v,o,h,c - h,i,0,o,u !== !1 && ("px" === m || "zIndex" === o),0,f,p),
            ...
            return o.cascadeTo = function(t, i, n) {
                var r, s, o, a = e.to(t, i, n), l = [a], h = [], u = [], c = [], f = e._internals.reservedProps;
        ...
        _gsScope._gsDefine("easing.Back", ["easing.Ease"], function(t) {
            ...
            return _.constructor = m,
                ...
                i = l("easing.RoughEase", function(e) {
                    e = e || {};
                    for (var i, n, r, s, o, a, l = e.taper || "none", h = [], u = 0, c = 0 | (e.points || 20), p = c, d = e.randomize !== !1, m = e.clamp === !0, _ = e.template instanceof t ? e.template : null, g = "number" == typeof e.strength ? .4 * e.strength : .4; --p > -1; )
...
_gsScope._gsDefine && _gsScope._gsQueue.pop()(),
        ...
        if (!i.TweenLite) {
            var n, r, s, o, a, l = function(t) {
                    ...
                    this.check = function(h) {
                        for (var u, c, f, p, _ = r.length, g = _; --_ > -1; )
            ...
            g("Ticker", function(t, e) {
                var i, n, r, s, l, h = this, c = C(), p = e !== !1 && P, d = 500, m = 33, _ = "tick", g = function(t) {
                    var e, o, a = C() - O;
                    a > d && (c += a - m),
                        O += a,
                        h.time = (O - c) / 1e3,
                    ...
                    for (this._targets = o = c(e),
                        ...
                        s = o[r],
                            s ? "string" != typeof s ? s.length && s !== t && s[0] && (s[0] === t || s[0].nodeType && s[0].style && !s.nodeType) ? (o.splice(r--, 1),
                                this._targets = o = o.concat(c(s))) : (this._siblings[r] = H(s, this, !1),
            ...
            var H = function(t, e, i) {
                ...
                var h, c = e._startTime + u, f = [], p = 0, d = 0 === e._duration;
                for (s = r.length; --s > -1; )
                    (a = r[s]) === e || a._gc || a._paused || (a._timeline !== e._timeline ? (h = h || Q(e, 0, d),
                    0 === Q(a, h, d) && (f[p++] = a)) : c >= a._startTime && a._startTime + a.totalDuration() / a._timeScale > c && ((d || !a._initted) && 2e-10 >= c - a._startTime || (f[p++] = a)));
                for (s = p; --s > -1; )
                    if (a = f[s],
            ...
            s._init = function() {
                ...
                s._initProps = function(e, i, n, r) {
                    ...
                    for (s in this.vars) {
                        if (u = this.vars[s],
                                W[s])
                            u && (u instanceof Array || u.push && p(u)) && -1 !== u.join("").indexOf("{self}") && (this.vars[s] = u = this._swapSelfInParams(u, this));
    ...
    !function(t, e) {
        ...
        t.Controller = function(n) {
            var s, o, a = "ScrollMagic.Controller", l = "FORWARD", h = "REVERSE", u = "PAUSED", c = i.defaults, f = this, p = r.extend({}, c, n), d = [], m = !1, _ = 0, g = u, v = !0, y = 0, T = !0, w = function() {
                for (var t in p)
                    c.hasOwnProperty(t) || delete p[t];
        ...
        t.Controller.addOption = function(t, e) {
            ...
            ,
            t.Scene = function(i) {
                var s, o, a = "BEFORE", l = "DURING", h = "AFTER", u = n.defaults, c = this, f = r.extend({}, u, i), p = a, d = 0, m = {
                    start: 0,
                    end: 0
                }, _ = 0, g = !0, v = function() {
                    for (var t in f)
                        u.hasOwnProperty(t) || delete f[t];
                    for (var e in u)
                        O(e);
                    S()
                }, y = {};
                ...
                var T = function() {
                    ...
                    o && f.triggerElement && (m.start -= o.info("size") * f.triggerHook),
                ...
                this.controller = function() {
                    ...
                    this.triggerPosition = function() {
                        var t = f.offset;
                        return o && (t += f.triggerElement ? _ : o.info("size") * c.triggerHook()),
                            t
                    }
                ;
                var E, R;
                ...
                var k = function(t) {
                    if (E && o) {
                        ...
                        if (t || p !== l) {
                            ...
                            R.pushFollowers ? f.duration > 0 && (p === h && 0 === parseFloat(r.css(R.spacer, "padding-top")) ? s = !0 : p === a && 0 === parseFloat(r.css(R.spacer, "padding-bottom")) && (s = !0)) : n[e.vertical ? "top" : "left"] = f.duration * d,
                                r.css(i, n),
                            s && z()
                        } else {
                    ...
                    if (E && o && R.inFlow) {
                        ...
                        R.pushFollowers && (s["padding" + (e ? "Top" : "Left")] = f.duration * d,
                            s["padding" + (e ? "Bottom" : "Right")] = f.duration * (1 - d)),
                            r.css(R.spacer, s)
                    }
                }
                    , A = function() {
                    ...
                    , L = function(t) {
                    o && E && p === l && !o.info("isDocument") && (t.preventDefault(),
                ...
                this.setPin = function(t, i) {
                    ...
                    if (a || r.extend(f, r.css(E, ["width", "height"])),
                            r.css(u, f),
                            u.setAttribute(e, ""),
                            ...
                            if (window.innerWidth >= c) {
                                if (h.hasClass("gh")) {
                                    ...
                                    var A = new ScrollMagic.Scene({
                                        ...
                                        E(t),
                                            "FORWARD" === t.scrollDirection ? et.addClass("end") : et.removeClass("end")
                                    }).addTo(a);
                                    g[w] = {
                                        type: l.circleReveal,
                                        sceneTweenPairs: [{
