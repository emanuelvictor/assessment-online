...
create table dispositivo (id  bigserial not null, created timestamp not null, updated timestamp, nome varchar(150) not null, primary key (id));
create table dispositivo_aud (id int8 not null, rev int8 not null, revtype int2, nome varchar(150));
