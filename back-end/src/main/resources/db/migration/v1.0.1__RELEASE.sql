...
-- Started on 2018-08-09 13:54:29 -03
...
--
-- TOC entry 175 (class 1259 OID 273623)
-- Name: flyway_schema_history; Type: TABLE; 
--
...
--
-- TOC entry 2045 (class 2606 OID 273631)
-- Name: flyway_schema_history_pk; Type: CONSTRAINT; 
--
...
--
-- TOC entry 2046 (class 1259 OID 273632)
-- Name: flyway_schema_history_s_idx; Type: INDEX; 
--
...
ALTER TABLE ONLY cidade_aud
    ADD CONSTRAINT fkefwyjn6arj763whxfdrto1s4e FOREIGN KEY (rev) REFERENCES auditing.revision(id);
...
ALTER TABLE ONLY configuracao_aud
    ADD CONSTRAINT fkeljinv8k5ln2wigpup838i4ml FOREIGN KEY (rev) REFERENCES auditing.revision(id);
...
ALTER TABLE ONLY estado_aud
    ADD CONSTRAINT fkh85yyhbouaqnu4pi1jqx6cghm FOREIGN KEY (rev) REFERENCES auditing.revision(id);
...
ALTER TABLE ONLY pessoa_aud
    ADD CONSTRAINT fkjutrachlrb2rljju7emg3rasl FOREIGN KEY (rev) REFERENCES auditing.revision(id);
...
ALTER TABLE ONLY colaborador_aud
    ADD CONSTRAINT fkkvbk7kvfhho91rrt51ltsm5he FOREIGN KEY (rev) REFERENCES auditing.revision(id);
...
ALTER TABLE ONLY endereco_aud
    ADD CONSTRAINT fkmnfywh0cf5m1x2kspb99laqim FOREIGN KEY (rev) REFERENCES auditing.revision(id);
...
ALTER TABLE ONLY pais_aud
    ADD CONSTRAINT fkmskwo6sjcn9897p2pfho4eyfd FOREIGN KEY (rev) REFERENCES auditing.revision(id);
...
ALTER TABLE ONLY conta_aud
    ADD CONSTRAINT fkqjvekwd6r9mpfnnqsmtpcx1qh FOREIGN KEY (rev) REFERENCES auditing.revision(id);
...
-- Completed on 2018-08-09 13:54:29 -03
